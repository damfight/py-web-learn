...
module.exports = function(){
    ...
    it('click: wd ( #kw, 313, 15, 0 )', async function(){
        await driver.sleep(300).wait('#kw', 30000)
               .sleep(300).mouseMove(313, 15).click(0);
    });

    it('sendKeys: huaweiyun', async function(){
        await driver.sendKeys('huaweiyun');
    });

    it('click: 百度一下 ( #su, 69, 14, 0 )', async function(){
        await driver.sleep(300).wait('#su', 30000)
               .sleep(300).mouseMove(69, 14).click(0);
    });

    it('× click: 华为云官网- +智能，见... ( #w9o73i a:nth-child(1), 145, 14, 0 )', async function(){
        await driver.sleep(300).wait('#w9o73i a:nth-child(1)', 30000)
               .sleep(300).mouseMove(145, 14).click(0);
    });
