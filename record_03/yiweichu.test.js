...
module.exports = function(){
    ...
    it('click: wd ( #kw, 158, 12, 0 )', async function(){
        await driver.sleep(300).wait('#kw', 30000)
               .sleep(300).mouseMove(158, 12).click(0);
    });

    it('sendKeys: 华为云', async function(){
        await driver.sendKeys('华为云');
    });

    it('click: 百度一下 ( #su, 47, 7, 0 )', async function(){
        await driver.sleep(300).wait('#su', 30000)
               .sleep(300).mouseMove(47, 7).click(0);
    });

    it('× click: 华为云官网- +智能，见... ( #vinjwq a:nth-child(1), 140, 12, 0 )', async function(){
        await driver.sleep(300).wait('#vinjwq a:nth-child(1)', 30000)
               .sleep(300).mouseMove(140, 12).click(0);
    });
    ...
    it('× click: #animation div.animation-coupon-close, 23, 19, 0', async function(){
        await driver.sleep(300).wait('#animation div.animation-coupon-close', 30000)
               .sleep(300).mouseMove(23, 19).click(0);
    });

    it('× mouseDown: #banner img, 1156, 33, 0', async function(){
        await driver.sleep(300).wait('#banner img', 30000)
               .sleep(300).mouseMove(1156, 33).mouseDown(0);
    });

    it('× click: 文档 ( //a[text()="文档"], 4, 7, 0 )', async function(){
        await driver.sleep(300).wait('//a[text()="文档"]', 30000)
               .sleep(300).mouseMove(4, 7).click(0);
    });
